...
function emailTemplateStructure($emailContent, $bodyTitle)
{
    ...
    $template .='<div style="text-align:center; width:95%; margin: auto; font-family: Roboto, sans-serif; background-image: url('.THEME_URL.'assets/email-images/bg.png); background-color: #263969; background-repeat: no-repeat; background-size: cover; padding-bottom: 100px; background-position: top center;">
        <table width="600" border="0" cellpadding="0" cellspacing="0" style="margin: auto; min-height: 200px; text-align:center; padding: 25px 0px 0px;">
            <tr>
                <td style="padding:15px 25px 35px 25px;">
                    <a href="#"><img src="'.THEME_URL.'assets/email-images/logo.png"></a>
                </td>
            </tr>
            <tr>
                <td style="color:#fff; font-size:30px; font-weight:700; padding:15px 25px; background-image: url'.THEME_URL.'assets/email-images/image.png); height: 196px; box-sizing: border-box; position: relative;">
                ...
                <td style="border:1px solid #1181DF; padding:20px 20px; margin: 20px; border-radius: 15px;">
                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <td width="40%" style="text-align: center;">
                            <img src="'.THEME_URL.'assets/email-images/logo.png">
                        </td>
                        <td align="center">
                            <p style="color: #e2e5ea; font-size: 12px; letter-spacing: 10px;">FOLLOW US</p>
                            <a style="padding:0px 5px;" href="#"><img src="'.THEME_URL.'assets/email-images/facebook.png"></a>
                            <a style="padding:0px 5px;" href="#"><img src="'.THEME_URL.'assets/email-images/linkedin.png"></a>
                            <a style="padding:0px 5px;" href="#"><img src="'.THEME_URL.'assets/email-images/twitter.png"></a>
                            <a style="padding:0px 5px;" href="#"><img src="'.THEME_URL.'assets/email-images/youtube.png"></a>
                        </td>
                        </tr>
                    </table>
                </td>
